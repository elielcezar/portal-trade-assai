...
<section id="content">    
  <?php print $messages; ?>
      ...
      <div class="tagline">
        <div class="container">
        <p>Presença nacional com estratégia regional para toda a rede de 240 lojas ou regionais </p>
        </div>
      </div>

      <div class="numeros">
        <div class="container">
          <img src="<?php print base_path() . path_to_theme() .'/' ?>img/estados.png" />
          <img src="<?php print base_path() . path_to_theme() .'/' ?>img/clientes.png" />
          <img src="<?php print base_path() . path_to_theme() .'/' ?>img/colaboradores.png" />
          <img src="<?php print base_path() . path_to_theme() .'/' ?>img/varejista.png" />
        </div>
      </div>
      ...
      <div id="app">
        ...
        <section class="lojas">   
          <div class="container">
            <div class="row">
              ...
              <h3>Confira todas as <strong>lojas Assaí</strong> </h3>
                
                <select v-model="estado" @change="fetchLojasMapa(estado)" id="lista-estados">     
                  <option value="" disabled>Selecione um Estado</option>                   
                  <option v-for="estado in estados" :value="estado" :key="estado">{{estado}}</option>
                </select>  

                <select v-model="lojaID" @change="fetchLoja(lojaID)" id="lista-lojas">     
                  <option value="" selected="selected">Selecione uma loja</option>                   
                  <option v-for="item in lojas" :value="item.loja_id" :key="item.loja_id">{{item.loja}}</option>
                </select>  

              </div>
              <div class="col">
              <svg version="1.1" id="svg-map" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="550px" height="560px" viewBox="0 0 450 460" enable-background="new 0 0 450 460" xml:space="preserve">
          <defs>
            <linearGradient id="MyGradient">
              <stop offset="0%" stop-color="#f5700e" />
              <stop offset="100%" stop-color="#faa71a" />
            </linearGradient>
          </defs>
          <g>
            <a href="#tocantins" class="ativo" aria-label="Tocantins" @click="fetchLojasMapa('Tocantins')">
            ...
            <a href="#bahia" class="ativo" aria-label="Bahia" @click="fetchLojasMapa('Bahia')">
            ...
            <a href="#sergipe" class="ativo" aria-label="Sergipe" @click="fetchLojasMapa('Sergipe')">
            ...
            <a href="#pernambuco" class="ativo" aria-label="Pernambuco" @click="fetchLojasMapa('Pernambuco')">
            ...
            <a href="#alagoas" class="ativo" aria-label="Alagoas" @click="fetchLojasMapa('Alagoas')">
            ...
            <a href="#rio-grande-do-norte" aria-label="Rio Grande do Norte" class="ativo" @click="fetchLojasMapa('Rio Grande do Norte')">
            ...
            <a href="#ceara" class="ativo" aria-label="Ceará" @click="fetchLojasMapa('Ceará')">
            ...
            <a href="#piaui" class="ativo" aria-label="Piauí" @click="fetchLojasMapa('Piauí')">
            ...
            <a href="#maranhao" class="ativo" aria-label="Maranhão" @click="fetchLojasMapa('Maranhão')">
            ...
            <a href="#amapa" class="ativo" aria-label="Amapá" @click="fetchLojasMapa('Amapá')">
            ...
            <a href="#para" class="ativo" aria-label="Pará" @click="fetchLojasMapa('Pará')">
            ...
            <a href="#roraima" class="ativo" aria-label="Roraima" @click="fetchLojasMapa('Roraima')">
            ...
            <a href="#amazonas" class="ativo" aria-label="Amazonas" @click="fetchLojasMapa('Amazonas')">
            ...
            <a href="#acre" class="ativo" aria-label="Acre" @click="fetchLojasMapa('Acre')">
            ...
            <a href="#rondonia" class="ativo" aria-label="Rondônia" @click="fetchLojasMapa('Rondônia')">
            ...
            <a href="#mato-grosso" class="ativo" aria-label="Mato Grosso" @click="fetchLojasMapa('Mato Grosso')">
            ...
            <a href="#mato-grosso-do-sul" aria-label="Mato Grosso do Sul" class="ativo" @click="fetchLojasMapa('Mato Grosso do Sul')">
            ...
            <a href="#goias" class="ativo" aria-label="Goiás" @click="fetchLojasMapa('Goiás')">
            ...
            <a href="#parana" class="ativo" aria-label="Paraná" @click="fetchLojasMapa('Paraná')">
            ...
            <a href="#sao-paulo" class="ativo" aria-label="São Paulo" @click="fetchLojasMapa('São Paulo')">
            ...
            <a href="#minas-gerais" class="ativo" aria-label="Minas Gerais" @click="fetchLojasMapa('Minas Gerais')">
            ...
            <a href="#rio-de-janeiro" class="ativo" aria-label="Rio de Janeiro" @click="fetchLojasMapa('Rio de Janeiro')">
            ...
            <a href="#distrito-federal" class="ativo" aria-label="Distrito Federal" @click="fetchLojasMapa('Distrito Federal')">
            ...
            <a href="#paraiba" class="ativo" aria-label="Paraíba" @click="fetchLojasMapa('Paraíba')">
        ...
        <section class="dados-loja" v-if="loja">
          <div class="container">
          <div class="infos">
              <div class="endereco">
                <p>{{loja.logradouro}}<br/><b>{{loja.cidade}}</b> - <b>{{loja.estado}}</b> - 81690-400</p>
              </div>
              <div class="telefone">
                <p><strong>Telefone:</strong> {{loja.telefone}}</p>
              </div>
              <div class="televendas">
                <p><strong>Espaço do Cliente:</strong> 0800 773 2322</p>
              </div>
              <div class="televendas">
                <p><strong>Televendas:</strong> {{loja.televendas}}</p>
              </div>
              <div class="horario">
                <p><strong>Horário de funcionamento:</strong><br>{{loja.horario}}</p>
              </div>
              <div class="email">
          ...
          <div class="servicos-iniciativas">
            <div class="servicos">
                <h4>Nesta loja você Encontra</h4>                 
                <ul>
                  <li v-for="item in listaEncontra" :key="item">{{item}}</li>
                </ul>                
            </div>   

            <div class="iniciativas">
                <h4>Iniciativas Sustentaveis</h4>
                <ul>
                  <li v-for="item in listaSustentaveis" :key="item">{{item}}</li>
                </ul> 
            </div>            
          </div>  
          </div>
